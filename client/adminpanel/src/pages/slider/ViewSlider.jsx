...
export default function ViewSlider() {
    ...
    let sliderTable = () => {
        axios.get(`${apiBaseurl}/slider/view`,
            ...
            .then((res) => res.data)
            .then((finalres) => {
                console.log(finalres.sliderData)
                setSliderlist(finalres.sliderData)
    ...
    let multidel = () => {
        ...
        axios.post(`${apiBaseurl}/slider/delete`, obj)
            .then((res) => {
                sliderTable()
            })
    }
                    ...
                    <table>
                        ...
                        {sliderlist.length >= 1 ?
                            ...
                            <tr key={v._id}>
                                ...
                                <td className=' w-[40%] text-left p-[10px_10px] text-gray-400 font-normal'>{v.sliderName}</td>
                                <td className=' w-[20%] p-[10px_10px] text-left text-gray-400 font-normal'>
                                    <img src={staticPath+v.sliderImage} alt="" className='w-[40px]' />
                                </td>
                                <td className=' w-[20%] p-[10px_10px] text-left text-gray-400 font-normal'>{v.sliderOrder}</td>
                                {v.sliderStatus ?
