...
export default function ViewMetrial() {
    ...
    let multidel = () => {
        ...
        axios.post(`${apiBaseurl}/material/delete`, obj)
            .then((res) => {
                materialTable()
            })
    }
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th className=' w-[60%] text-left p-[10px_10px] text-gray-400 font-normal'>MATERIAL NAME</th>
                                    ...
                                    return (
                                        <tr  key={v._id}>
                                            <td className=' w-[5%] p-[10px_10px] text-gray-400 font-normal'><input type="checkbox"
                                                ...
                                                onChange={delitems}
                                            /></td>
                                            <td className=' w-[60%] text-left p-[10px_10px] text-gray-400 font-normal'>{v.materialName}</td>
                                            <td className=' w-[20%] p-[10px_10px] text-left text-gray-400 font-normal'>{v.materialOrder}</td>
