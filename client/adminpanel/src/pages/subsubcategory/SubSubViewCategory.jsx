...
export default function SubSubViewCategory() {
    ...
    let subsubCategoryTable = () => {
        axios.get(`${apiBaseurl}/subsubCategory/view`,
            ...
            .then((finalres) => {
                ...
                setsubsubCategorylist(finalres.subsubCategoryData)
    ...
    let multidel = () => {
        ...
        axios.post(`${apiBaseurl}/subsubCategory/delete`, obj)
            .then((res) => {
                subsubCategoryTable()
            })
    }
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th className=' w-[30%] text-left p-[10px_5px] text-gray-400 font-normal text-[14px]'> PARENT CATEGORY </th>
                                <th className=' w-[30%] p-[10px_10px] text-left text-gray-400 font-normal text-[14px]'>SUB CATEGORY </th>
                                <th className=' w-[30%] p-[10px_10px] text-left text-gray-400 font-normal text-[14px]'> CATEGORY NAME</th>
                        ...
                        {subsubCategorylist.length >= 1 ?
                            ...
                            <tr>
                                ...
                                <td className=' w-[30%] text-left p-[10px_5px] text-gray-400 font-normal'>{v.subsubCategoryName}</td>
                                <td className=' w-[30%] p-[10px_10px] text-left text-gray-400 font-normal'>{v.subsubCategoryParent}</td>
                                <td className=' w-[30%] p-[10px_10px] text-left text-gray-400 font-normal'>{v.subsubCategory}</td>
                                <td className=' w-[15%] p-[10px_10px] text-left text-gray-400 font-normal'>
                                    <img src={staticPath+v.subsubCategoryImage} alt="" className='w-[40px]' />
                                </td>
                                <td className=' w-[10%] p-[10px_10px] text-left text-gray-400 font-normal'>{v.subsubCategoryOrder}</td>
                                {v.subsubCategoryStatus ?
