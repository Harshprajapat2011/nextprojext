...
export default function NewsSeltermana() {
                           ...
                           <div>
                               <table>
                                   <thead>
                                       ...
                                       <th className=' w-[20%] p-[10px_10px] text-left text-gray-400 font-normal'>MAIL ID</th>
                                       <th className=' w-[20%] p-[10px_10px] text-left text-gray-400 font-normal'>MOBILE NUMBER</th>
